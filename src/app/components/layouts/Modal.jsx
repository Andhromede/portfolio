        ...
        <div>
            ...
            {open && (
                <div onClick={onClose} className="overlay h-full">
                    <div role="alert" className="rounded-xl border border-gray-100 w-fit mt-20 p-4 mx-auto bg-black p-2">
                        <div className="flex items-start gap-4">
                            ...
                            <button onClick={onClose} className="text-gray-500 transition hover:text-gray-400">
